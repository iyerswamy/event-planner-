const firebaseConfig = {
  ...
  function submitForm(e) {
    ...
    var nameofthemother = getElementVal("nameofthemother");
    ...
    saveMessages(eventplan, nameofthemother,  phonenumber, alternativephonenumber, city, state, guests, eventdate, eventtime,   emailid, msgContent);
  ...
  const saveMessages = (eventplan, nameofthemother, phonenumber, alternativephonenumber, city, state, guests, eventdate, eventtime,  emailid, msgContent) => {
    var newContactForm = contactFormDB.push();
  
    newContactForm.set({
      eventplan:eventplan,
      nameofthemother:nameofthemother,
