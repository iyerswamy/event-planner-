const firebaseConfig = {
  ...
  function submitForm(e) {
    ...
    var nameofthebirthdayperson = getElementVal("nameofthebirthdayperson");
    ...
    saveMessages(eventplan, nameofthebirthdayperson, age, phonenumber, alternativephonenumber, city, state, guests, eventdate, eventtime,   emailid, msgContent);
  ...
  const saveMessages = (eventplan, nameofthebirthdayperson, age, phonenumber, alternativephonenumber, city, state, guests, eventdate, eventtime,  emailid, msgContent) => {
    var newContactForm = contactFormDB.push();
  
    newContactForm.set({
      eventplan:eventplan,
      nameofthebirthdayperson:nameofthebirthdayperson,
      age:age,
